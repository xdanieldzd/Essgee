...
namespace Essgee.Emulation.PSG
{
	public class SegaSMSPSG : SN76489
	{
		...
		public SegaSMSPSG(int sampleRate, int numOutputChannels, EventHandler<EnqueueSamplesEventArgs> enqueueSamplesEvent) : base(sampleRate, numOutputChannels, enqueueSamplesEvent) { }
